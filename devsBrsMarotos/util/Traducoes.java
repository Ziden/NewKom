...
public class Traducoes {
    ...
    private void loadLang() {
        File langFile = new File(NewKom.instancia.getDataFolder().getAbsolutePath() + File.separator + "MinecraftLang.lang");
        if (!langFile.exists()) {
            NewKom.log.info("No language file could be found, defaulting to internal Bukkit item names");
            return;
        }
        try {
