...
public class BookUtil {
    ...
    public static boolean ehLivroDeQuest(ItemStack otroLivro) {
        if(otroLivro.getType()==Material.WRITTEN_BOOK) {
            ...
            if(m!=null && m.getDisplayName()!=null && m.getDisplayName().contains("[Key]"))
                return true;
        }
        return false;
    }
                ...
                for (ItemStack coisa : c.getBlockInventory().getContents()) {
                    if (coisa != null && (coisa.getType() == Material.WRITTEN_BOOK)) {
                        ...
                        if (ev.getPlayer().hasMetadata(m.getTitle())) {
                            ev.getPlayer().sendMessage(ChatColor.RED + L.m("You have this book already !"));
                            return;
                        }
                        
                        ev.getPlayer().getInventory().addItem(otroLivro);
                        ev.getPlayer().updateInventory();
                        ev.getPlayer().sendMessage(ChatColor.AQUA + L.m("You got the book !"));
                ...
                for (ItemStack coisa : c.getBlockInventory().getContents()) {
                    if (coisa != null && (coisa.getType() == Material.WRITTEN_BOOK || coisa.getType() == Material.BOOK_AND_QUILL)) {
                        ...
                        if (m.getTitle() != null && m.getTitle().equalsIgnoreCase("musica")) {
                            ...
                            Location l = BookPortal.getLocationFromBook(coisa);
                            if (l != null) {
                                ...
                                ev.getPlayer().sendMessage(ChatColor.RED + L.m("This teleporter is broken..."));
                            }
                        } else {
                            ...
                            for (String msg : m.getPages()) {
                                ev.getPlayer().sendMessage(ChatColor.DARK_AQUA + "[" + ChatColor.AQUA + ChatColor.BOLD + (m.getTitle() == null ? "Jabu" : m.getTitle()) + ChatColor.DARK_AQUA + "]" + ChatColor.GOLD + " " + msg.replace("\n", " "));
                            }
                            break;
                        }
