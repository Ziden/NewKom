 ...
 * @author User
 */
public class WeakExplosion extends CustomPotion {

    private int damage = 3;
    private DamageCause damageType = DamageCause.ENTITY_EXPLOSION;
    
    public WeakExplosion() {
        super(L.m("Weak Explosion Potion"),L.m("Makes a small KBOOM"), PotionType.INSTANT_DAMAGE, true);
    }
