package devsBrsMarotos.mechanic.list.Scoreboard;
...
public class ScoreboardManager extends Mecanica {
    
    public static String HoraAtual = "   ";
    private static FakeScoreboard mainScoreboard = new FakeScoreboard();
    private static boolean useOfflinePlayer = false;
    private static boolean useOfflineTeams = false;
    ...
    public void join(PlayerJoinEvent ev) {
        registerScoreboard(ev.getPlayer());
    }
